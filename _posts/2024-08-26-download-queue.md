...
따라서 Redis Set을 사용하여 다운로드 처리열을 구현했습니다.
...
애플리케이션 종료 시에는 처리셋(processing_set)에 있는 모든 작업을 꺼내서 대기열(waiting_queue) 맨 앞에 추가합니다. 그럼 애플리케이션이 다시 시작하더라도 중단된 다운로드 작업은 다시 시작할 수 있을 것입니다.
